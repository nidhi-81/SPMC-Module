...
// Use prepared statement to prevent SQL injection
$query_objs = $conn->prepare("SELECT * FROM $table_name_resume");
$query_objs->execute();
        ...
        <tbody>
            <?php foreach ($objs as $obj): ?>
                <tr>
                    ...
                    <td data-label="✘">
    <form action="tbfac2.php" method="post" onsubmit="return confirm('Are you sure you want to delete this faculty?');">
    ...
    <div class="container">
        <div class="center">
            <a href="add_faculty_form.php">
                <button class='add'><h3>Add new faculty</h3></button>
            </a>
        </div>
    </div>
</body>
