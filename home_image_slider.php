...
<html>
    ...
    <head>
        <title>Add image to slider</title>
        <style>
            body {
                display: flex;
    ...
    <body>
        <div class="container">
            <h1>Add image to home slider</h1>
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                $sql = "INSERT INTO home_image_slider VALUES ('$UploadPath')";
            ...
            <form action="home_image_slider.php" method="post" enctype="multipart/form-data">
